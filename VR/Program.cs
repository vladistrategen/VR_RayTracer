        ...
        public static void Main(string[] args)
        {
            ...
            var geometries = new Geometry[]
            {
                ...
                new Sphere(
                    ...
                    50.0,
                    new Material(
                        new Color(255, 0.0, 0.1, 1.0),
                        new Color(255, 0.0, 0.3, 1.0),
                        new Color(255, 0.0, 0.5, 1.0),
                        10
                    ),
                    new Color(0.0, 0.0, 0.8, 1.0)
                ),
                new Sphere(
                    new Vector(20.0, 20.0, 150.0),  
                    25.0,
                    new Material(
